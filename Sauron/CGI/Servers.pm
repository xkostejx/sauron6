...
my %server_form = (
 data=>[
  ...
  {ftype=>1, tag=>'hostaddr', name=>'IP address',type=>'ip',empty=>0, len=>40},
  ...
  {ftype=>1, tag=>'transfer_source', name=>'Transfer source IP',
   type=>'ip4', empty=>1, definfo=>['','Default'], len=>40, ver=>4},
  {ftype=>1, tag=>'transfer_source_v6', name=>'Transfer source IPv6',
   type=>'ip6', empty=>1, definfo=>['','Default'], len=>40, ver=>6},
  {ftype=>1, tag=>'query_src_ip', name=>'Query source IP',
   type=>'ip4', empty=>1, definfo=>['','Default'], len=>40},
  ...
  {ftype=>1, tag=>'query_src_ip_v6', name=>'Query source IPv6',
   type=>'ip6', empty=>1, definfo=>['','Default'], len=>40},
